...
mylabel1 = tk.Label(top, bd=5, fg='#000', bg='#fbfafe', font=('Arial',10,'bold'), text='1', bitmap='info', compound='left')  # bitmap show left
...
mylabel2 = tk.Label(top, bd=5, fg='#000', bg='#fbfafe', font=('Arial',10,'bold'), text='2', bitmap='info', compound='left')  # 建立 label 標籤
...
mylabel3 = tk.Label(top, bd=5, fg='#000', bg='#fbfafe', font=('Arial',10,'bold'), text='3', bitmap='info', compound='left')  # 建立 label 標籤
...
mylabel4 = tk.Label(top, bd=5, fg='#000', bg='#fbfafe', font=('Arial',10,'bold'), text='4', bitmap='info', compound='left')  # 建立 label 標籤
...
mylabel5 = tk.Label(top, bd=5, fg='#000', bg='#fbfafe', font=('Arial',10,'bold'), text='5', bitmap='info', compound='left')  # 建立 label 標籤
...
mylabel6 = tk.Label(top, bd=5, fg='#000', bg='#fbfafe', font=('Arial',10,'bold'), text='6', bitmap='info', compound='left')  # 建立 label 標籤
...
mylabel7 = tk.Label(top, bd=5, fg='#000', bg='#fbfafe', font=('Arial',10,'bold'), text='7', bitmap='info', compound='left')  # 建立 label 標籤
mylabel7.pack(fill='x')
startButton7 = tk.Button(top, bd=5, bg='#FF7F7F',text="伺服馬達90度來回3次", command=servoBack)
startButton7.pack(fill='x')

mylabel8 = tk.Label(top, bd=5, fg='#000', bg='#fbfafe', font=('Arial',10,'bold'), text='8', bitmap='info', compound='left')  # 建立 label 標籤
...
mylabel9 = tk.Label(top, bd=5, fg='#000', bg='#fbfafe', font=('Arial',10,'bold'), text='9', bitmap='info', compound='left')  # 建立 label 標籤
mylabel9.pack(fill='x')
startButton9 = tk.Button(top, bd=5, bg='#FF7F7F',text="蜂鳴器", command=beep)
startButton9.pack(fill='x')
